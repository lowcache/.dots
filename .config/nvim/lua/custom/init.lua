...
-- Snippet paths
vim.g.vscode_snippets_path = "~/.config/nvim-Vimacs/lua/custom/snippets/json"
vim.g.lua_snippets_path = "~/.config/nvim-Vimacs/lua/custom/snippets/lua"
vim.g.snipmate_snippets_path = "~/.config/nvim-Vimacs/lua/custom/snippets/snipmate"
